...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Music instrument store!</h1>
                    <p>We have the best Musical instruments all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Bansurii.jpg" alt="Bansuri">
                            </a>
                            <center>
                                <div class="caption">
                                   <h3>Bansuri</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Dholki.jpg" alt="Dholki">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dholki</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php"><br>
                                <img src="img/Sarangi.jpg" alt="Sarangi">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sarangi</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php"><br>
                                <img src="img/Drumset.jpg" alt="Drumset">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Drumset</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php"><br><br><br>
                                <img src="img/Vina.jpg" alt="Veena">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Veena</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <br><br><br>
                                <img src="img/Harmonic.jpg" alt="Harmonica">
                                <br><br>
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Pianoo.jpg" alt="Piano">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Piano</h3>
